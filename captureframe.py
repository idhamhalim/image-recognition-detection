...
while success:
    ...
    if count%7 == 0 :
         ...
         cv2.imwrite(os.path.join(mypath ,'framee%s.jpg'%timestr),image)
         #saving images to mypath
         #cv2.imwrite(os.path.join(mypath ,'frames%d.jpg'%count,image)
         print('success')
    count+=1

#setting path of folder with input images,
#can be configured for your own path/folder
#mypath='/home/idham/darkflow-master/image/'
